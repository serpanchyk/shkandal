      ...
      <div className="aboutSections">
        <section>
          ...
          <p>
            ...
            у різні дні та в різних джерелах. Шкандаль поєднує ці публікації у
            читацькі досьє з коротким поясненням, часописом подій, згаданими особами
            й установами та посиланнями на пов’язані справи.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            підтверджені публікаціями події й згадки. Кожна картка матеріалу веде
        ...
        <section>
          ...
          <p>
            ...
            неточності. Згадка особи чи установи не означає вини,
            відповідальності або формальної участі. Перевіряйте важливі
            твердження за першоджерелами.
          </p>
        </section>
