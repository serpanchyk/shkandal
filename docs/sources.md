...
| `rbc` | media | Validated 2026-06-13 | Not configured | `https://www.rbc.ua/static/sitemap/newsukr.xml` | Not configured | Include article `.html` paths; exclude top pages | Rolling Ukrainian current-news sitemap only; no historical backfill. |
| `censor` | media | Validated 2026-06-13 | `https://assets.censor.net/rss/censor.net/rss_uk_news.xml` | Not configured | Not configured | Include `/ua/news/<id>/<slug>` | Rolling Ukrainian news RSS only; no historical backfill. |
| `tsn` | media | Validated 2026-06-13 | Not configured | `https://tsn.ua/sitemap/google_news_uk.xml` | Not configured | Include Ukrainian `.html` articles; exclude print pages | Rolling Ukrainian Google News sitemap only; no historical backfill. |
| `24tv` | media | Validated 2026-06-13 | Not configured | `https://24tv.ua/resources/xml/subdomain_sitemaps/24/sitemap-latest-news.xml` | Not configured | Include article paths ending in `_n<id>` | Rolling Ukrainian latest-news sitemap only; no historical backfill. |
| `unian` | media | Validated 2026-06-13 | Not configured | `https://www.unian.ua/sitemap.last.news.xml` | Not configured | Include article `.html` paths ending in an ID; exclude mobile paths | Rolling Ukrainian current-news sitemap only; no historical backfill. |
